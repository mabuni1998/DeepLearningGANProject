...
if __name__ == "__main__":
    ...
    run = wandb.init(project="mnist-WGAN_spec", entity="gan_project_cm",config=config)
    ...
    #Save model
    generatorpath = os.getcwd()+'/models/WGAN_spec_mnist_g.pth'
    discriminatorpath = os.getcwd()+'/models/WGAN_spec_mnist_d.pth'
