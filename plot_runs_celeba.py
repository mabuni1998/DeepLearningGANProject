...
df_GAN = pd.read_csv(cwd+"/data_for_plots/CelebA_GAN.csv")
df_spectralnorm = pd.read_csv(cwd+"/data_for_plots/CelebA_spec.csv")
df_weightclipping = pd.read_csv(cwd+"/data_for_plots/CelebA_weight.csv")
df_GP = pd.read_csv(cwd+"/data_for_plots/CelebA_GP.csv")
...
ax.set_title("CelebA - 5 experiments")
plt.tight_layout()
plt.savefig(cwd+"/plots/CelebA_runs.svg")