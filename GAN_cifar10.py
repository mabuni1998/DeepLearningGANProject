...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        for x,_ in train_loader:
            ...
            d_loss_real = loss_fn(output_true,real_labels)
            ...
            #d_loss_f = loss_fn(output_fake,fake_labels)
            
            output_fake = discriminator(x_fake)
            
            g_loss = loss_fn(output_fake,real_labels)
            #g_loss = -(output_fake).log().mean()
            g_loss.backward()
            generator_optim.step()
            
            batch_d_loss.append((d_loss_real/(d_loss_fake+d_loss_real)).item())
